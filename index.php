...
<div class="container">
    ...
    <main class="main">
        <h2 class="post_tittle">For you</h2>
        <div class="posting_container">
            <form class="posting_form" action="vendor/posts.php" method="post">
                <textarea placeholder="What is happening?!" name="user_post" required class="post_area" id="myTextarea"></textarea>
                <div class="button_wrapper"><button class="button post_button" type="submit">Post</button></div>
            </form>
        </div>
        <div class="content">
